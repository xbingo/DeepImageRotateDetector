...
_INPUT_PATH = '/Users/rubinxie/data/TestRotate'

_OUTPUT_PATH = '/Users/rubinxie/data/RotateRecord'
...
def _get_dataset_filename(dataset_dir, split_name, shard_id):
  output_filename = 'rotate_%s_%05d-of-%05d.tfrecord' % (
    ...
    with tf.Session('') as sess:
      ...
      for shard_id in range(_NUM_SHARDS):
        output_filename = _get_dataset_filename(
            _OUTPUT_PATH, split_name, shard_id)
